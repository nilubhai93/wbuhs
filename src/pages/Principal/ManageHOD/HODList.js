...
const HODList = () => {
  ...
  const filteredHods = hods.filter(hod => {
    const matchesSearch = hod.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         hod.employeeId.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesDepartment = filterDepartment === 'All' || hod.department === filterDepartment;
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-800">Manage HODs</h2>
              <p className="text-gray-600 mt-1">View and manage all Heads of Departments in the institution.</p>
            </div>
          </div>
                  ...
                  <tr key={hod.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{hod.employeeId}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-700">
                Showing 1 to {filteredHods.length} of {filteredHods.length} results
              </div>
              <div className="flex space-x-2">
