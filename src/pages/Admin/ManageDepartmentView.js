...
const ManageDepartmentDetails = () => {
    ...
    const department = getDepartmentById(parseInt(deptId));
    const departmentTeachers = getTeachersByDepartmentIdAcrossColleges(parseInt(deptId));
    const departmentStudents = getStudentsByDepartmentIdAcrossColleges(parseInt(deptId));
    ...
    const filteredCollegeHODs = selectedCollege ? hods.filter(hod => {
        ...
        return matchesSearch && hod.collegeId === selectedCollege.id && hod.departmentId === parseInt(deptId);
    }) : [];
...
export default ManageDepartmentDetails;
