...
import { FaCalendarCheck, FaChartBar, FaClipboardList, FaTachometerAlt, FaTimes, FaUser, FaUsers } from 'react-icons/fa';
...
const TeacherSidebar = ({
  ...
  const menuItems = [
    ...
    { path: "/teacher/manage-student", label: "Manage Students", icon: '👥' },
