...
const PrincipalSidebar = ({
  ...
  const menuItems = [
    ...
    { path: "/principal/manage-student", label: "Manage students", icon: "👥" },
    { path: "/principal/manage-hod", label: "Manage HODs", icon: "👨‍🏫" },
    { path: "/principal/manage-teacher", label: "Manage Teachers", icon: "👩‍🏫" },
    { path: "/principal/college-info", label: "College Info", icon: "🏫" },
    { path: '/principal/view-application',label: 'View Application',icon: '📋'},
    { path: "/principal/principalprofile", label: "Principal Profile", icon: "👤" },
