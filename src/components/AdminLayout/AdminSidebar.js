...
const AdminSidebar = ({
  ...
  const menuItems = [
    ...
    { path: '/admin/manage-college', label: 'Manage College', icon: '🏫' },
    { path: '/admin/manage-department', label: 'Manage Department', icon: '🏥' },
    { path: '/admin/view-application', label: 'View Application', icon: '📋' },
