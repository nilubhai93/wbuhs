...
const StudentSidebar = ({
  ...
  const menuItems = [
    ...
    { path: '/student/profile', label: 'Student Profile', icon: '👤' },
    { path: '/student/academic-records', label: 'Academic Records', icon: '📋' },
    { path: '/student/clinical-rotations', label: 'Clinical Rotations', icon: '🏥' },
    { path: '/student/fees', label: 'Fees', icon: '💳' },
    { path: '/student/library', label: 'Library', icon: '📚' },
    { path: '/student/research', label: 'Research Projects', icon: '🔬' },
    { path: '/student/examinations', label: 'Examinations', icon: '📝' },
    // { path: '/student/medical-records', label: 'Medical Records', icon: '🩺' }
  ];
